...
import { formatCurrency, formatDecimal, px2hp, px2wp } from "@/utils/common";
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
                    ...
                    <View style={styles.rechargeContent}>
                      <View style={styles.coinAmount}>
                        ...
                        <Text style={styles.coinText}>
                          {formatDecimal(option.coins_amount + option.bonus, 0)}
                        </Text>
                      </View>
                      <View style={styles.priceTag}>
                        <Text style={styles.priceText}>
                          {formatCurrency(option.amount / 100)}
                        </Text>
                      </View>
                    </View>
                    {option.is_popular && (
        ...
        {rechargeOptions.length ? (
          ...
          >
            {paymentLoading ? t("common.processing") : t("common.confirm")}
          </Button>
        ) : null}
      </View>
